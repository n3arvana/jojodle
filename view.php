...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="views/styleView.css">
  </head>
  <body>
            ...
            <div class="card-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  $stands = mysqli_query($conexao, $sql);
                  if (mysqli_num_rows($stands) > 0) {
              ...
              <div class="text-center mt-4">
                ...
                <a href="views/jogo.php" class="btn btn-jojo btn-lg">Ir para o Jogo</a>
              </div>
            </div>
          </div>
        </div>
